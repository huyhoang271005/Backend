package com.example.hello.Infrastructure.Common.Constant;
...
public final class ParamName {
    ...
    public static final String USER_ID_JWT = "userId";
    public static final String TOKEN_NAME_JWT = "tokenName";
    public static final String SESSION_ID_JWT = "sessionId";
}
